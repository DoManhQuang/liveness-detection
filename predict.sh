...
--path_root "./data/private_test" \
--folder_ex_frame "frame-video-private-test"

python tools/dict-data-test.py \
--save "./data/private_test" \
--path_data "./data/private_test/frame-video-private-test" \
...
--path_data "./data/private_test/private-test-data-5x300x100x3.data" \
-v "v1.0" \
